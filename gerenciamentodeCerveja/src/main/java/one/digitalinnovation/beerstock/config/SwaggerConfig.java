...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Bianca Gomes";
    private static final String CONTACT_GITHUB = "https://github.com/Bia-gg";
    private static final String CONTACT_EMAIL = "bibi.gomes.f@gmail.com";
